  ...
  return (
    <div className="container my-5 pt-3">
      <div className="row">
        {cartItems.length > 0 ? (
          <motion.div
            className="added-items col-xl-8 col-lg-8 d-flex flex-wrap p-0 order-2"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <p className="mt-5 pt-5 col-xl-8 col-lg-8 d-flex flex-wrap justify-content-center order-2">
            No items in the cart, click{" "}
            <Link
              to="/orderStatus"
              className="mx-1"
            ...
            to view your last order status
          </p>
        )}
        <section className="order col-lg-4 col-md-12 order-lg-2 order-1">
          <motion.div
